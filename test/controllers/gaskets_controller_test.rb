...
class GasketsControllerTest < ActionController::TestCase
  ...
  test "should create gasket" do
    assert_difference('Gasket.count') do
      post :create, gasket: { classc: @gasket.classc, codeno: @gasket.codeno, material: @gasket.material, nb: @gasket.nb, quantity: @gasket.quantity, slno: @gasket.slno, thk: @gasket.thk, typec: @gasket.typec }
    end
  ...
  test "should update gasket" do
    patch :update, id: @gasket, gasket: { classc: @gasket.classc, codeno: @gasket.codeno, material: @gasket.material, nb: @gasket.nb, quantity: @gasket.quantity, slno: @gasket.slno, thk: @gasket.thk, typec: @gasket.typec }
    assert_redirected_to gasket_path(assigns(:gasket))
  end
