...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { closesin: @individual.closesin, description: @individual.description, price: @individual.price, uid: @individual.uid }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { closesin: @individual.closesin, description: @individual.description, price: @individual.price, uid: @individual.uid }
    assert_redirected_to individual_path(assigns(:individual))
  end
