...
class BearingsControllerTest < ActionController::TestCase
  ...
  test "should create bearing" do
    assert_difference('Bearing.count') do
      post :create, bearing: { codeno: @bearing.codeno, materialdescription: @bearing.materialdescription, quantity: @bearing.quantity, size: @bearing.size, slno: @bearing.slno, typec: @bearing.typec }
    end
  ...
  test "should update bearing" do
    patch :update, id: @bearing, bearing: { codeno: @bearing.codeno, materialdescription: @bearing.materialdescription, quantity: @bearing.quantity, size: @bearing.size, slno: @bearing.slno, typec: @bearing.typec }
    assert_redirected_to bearing_path(assigns(:bearing))
  end
