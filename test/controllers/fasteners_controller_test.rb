...
class FastenersControllerTest < ActionController::TestCase
  ...
  test "should create fastener" do
    assert_difference('Fastener.count') do
      post :create, fastener: { codeno: @fastener.codeno, grade: @fastener.grade, item: @fastener.item, quantity: @fastener.quantity, size: @fastener.size, slno: @fastener.slno, typec: @fastener.typec }
    end
  ...
  test "should update fastener" do
    patch :update, id: @fastener, fastener: { codeno: @fastener.codeno, grade: @fastener.grade, item: @fastener.item, quantity: @fastener.quantity, size: @fastener.size, slno: @fastener.slno, typec: @fastener.typec }
    assert_redirected_to fastener_path(assigns(:fastener))
  end
