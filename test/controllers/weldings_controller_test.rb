...
class WeldingsControllerTest < ActionController::TestCase
  ...
  test "should create welding" do
    assert_difference('Welding.count') do
      post :create, welding: { UOM: @welding.UOM, codeno: @welding.codeno, description: @welding.description, quantity: @welding.quantity, slno: @welding.slno }
    end
  ...
  test "should update welding" do
    patch :update, id: @welding, welding: { UOM: @welding.UOM, codeno: @welding.codeno, description: @welding.description, quantity: @welding.quantity, slno: @welding.slno }
    assert_redirected_to welding_path(assigns(:welding))
  end
